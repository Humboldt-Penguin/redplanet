...
def test__get_dirpath_datacache__default_value():
...
## Valid input: string
def test__set_dirpath_datacache__valid_string():
...
def test__set_dirpath_datacache__valid_path_object():
...
def test__set_dirpath_datacache__invalid_string():
	invalid_path_str = "\0"
...
def test__set_dirpath_datacache__invalid_type():
